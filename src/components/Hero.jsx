    ...
    <section className="relative w-full min-h-screen overflow-hidden bg-background font-sans">
      ...
      >
        <div className="order-1 w-full max-w-xl text-center lg:order-2 lg:col-start-2 lg:row-start-1 lg:self-end lg:text-left">
          ...
          <motion.h1
            variants={fadeUp}
            className="mt-4 font-heading text-[1.45rem] leading-tight font-extrabold tracking-tight text-text sm:text-[2.7rem] lg:mt-5 lg:text-[3rem] lg:leading-[1.05]"
          >
            ...
            {featureCards.map(({ icon: Icon, label, position, delay, floatDuration }) => (
              ...
              >
                <motion.div
                  ...
                  className="glass-card flex items-center gap-2 rounded-xl px-2.5 py-2 transition-all duration-300 hover:border-primary/20 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] sm:gap-2.5 sm:rounded-2xl sm:px-4 sm:py-3"
                >
        ...
        <div className="order-3 w-full max-w-xl text-center lg:col-start-2 lg:row-start-2 lg:self-start lg:text-left">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="group inline-flex items-center justify-center gap-1 rounded-full bg-cta px-2.5 py-1.5 text-[0.72rem] font-semibold text-white transition-all hover:bg-cta-hover sm:gap-1.5 sm:px-6 sm:py-2.5 sm:text-sm"
            >
              Request A Machine
            ...
            <motion.button
              whileHover={{ scale: 1.035, y: -1 }}
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center gap-1 rounded-full border border-neutral-300 bg-white px-2.5 py-1.5 text-[0.72rem] font-semibold text-text transition-all hover:border-primary/30 hover:bg-primary/5 sm:gap-1.5 sm:px-6 sm:py-2.5 sm:text-sm"
            >
              Explore Solutions
            </motion.button>
          </motion.div>
        ...
        <motion.div
          variants={fadeUp}
          className="order-4 mt-8 w-full lg:col-span-2 lg:col-start-1 lg:row-start-4 lg:mt-0 lg:text-center"
        >
